...
async def run_test():
    ...
    try:
        ...
        # Click the 'Get Started' button to navigate to the registration page.
        ...
        # Input the first invalid email (missing '@') with valid first name, last name, password, and confirm password, then submit the form.
        frame = context.pages[-1]
        ...
        # Input the second invalid email format (missing domain) and submit the form to verify validation error.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[2]/div/div/div[2]/form/div[2]/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('user@invalid')
        ...
        # Input the third invalid email format (email with spaces) and submit the form to verify validation error.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[2]/div/div/div[2]/form/div[2]/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('user @invalid.com')
        ...
        # Assert that the validation error message for invalid email is displayed after each invalid email submission
        error_message_locator = frame.locator('text=Please enter a valid email address')
